...
func (s *BawangContract) CreateBawang(ctx contractapi.TransactionContextInterface, bawangData string) (string, error) {
	...
	bawang.GenesisID = ctx.GetStub().GetTxID()
...
func (s *BawangContract) CreateTrxBawangByPenangkar(ctx contractapi.TransactionContextInterface, bawangData, prevID string) (string, error) {
	...
	if bawangInit.KuantitasBenihKg - bawang.KuantitasBenihKg > 0 {
		...
		_, err = s.updateBawangKuantitasByID(ctx, prevID, bawang.KuantitasBenihKg)
...
func (s *BawangContract) UpdateBawangTrxByPetani(ctx contractapi.TransactionContextInterface, bawangData, prevID string) (string, error) {
	...
	// Unmarshaling from previous bawang
	err = json.Unmarshal(bawangAsBytes, bawangPrev)
	// Unmarshaling from newly inputted bawang 
	...
	// Set UID
	// bawangNew.UID1 = bawangPrev.UID1
	// bawangNew.UID2 = creatorUID

	// bawangNew.CreatorUID = creatorUID
...
func (s *BawangContract) UpdateBawangTrxByPengumpul(ctx contractapi.TransactionContextInterface, bawangData, prevID string) (string, error) {
	...
	// Add bawang price
	bawangNew.KuantitasBawangKg = bawangPrev.KuantitasBawangKg
	bawangNew.HargaBawangPerKg = bawangPrev.HargaBawangPerKg
	...
	// // Add unique field
	// bawangNew.TanggalMasuk = bawangPrev.TanggalMasuk
	// bawangNew.AlamatGudang = bawangPrev.AlamatGudang
	// bawangNew.TeknikSorting = bawangPrev.TeknikSorting
	// bawangNew.MetodePengemasan = bawangPrev.MetodePengemasan
	...
	// bawangNew.UID1 = bawangPrev.UID1
	// bawangNew.UID2 = bawangPrev.UID2
	// bawangNew.UID3 = creatorUID
...
func (s *BawangContract) updateBawangKuantitasByID(ctx contractapi.TransactionContextInterface, bawangID string, kuantitasBenihNext float64 ) (string, error) {
	if len(bawangID) == 0 {
		return "", fmt.Errorf("Please inser the correct bawang id")
	}

	//if len(nextID) == 0 {
	//	return "", fmt.Errorf("Please inser the correct next bawang id")
	//}
	...
	//	return "", fmt.Errorf("Bawang trx with %s id does not exist", nextID)
	//}
